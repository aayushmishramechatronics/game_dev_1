//Made by Aayush Mishra, OSS - no requests required
...
//Made by Aayush Mishra, OSS - no requests required
	this.stopGame = function() {
		...
		var newScore = game.add.bitmapText(game.width/2 + 60, 107, 'scorefont', this.score+'', 20, scoreGroup);//this.score
	...
	this.checkScore = function(pipe) {
		if (pipe.anchor.y == 1 && !pipe.counted)//pipe.counted
		{
